<template>
  <div class="main_contain" style="height: 700px">
    <div class="headerd">
      <span class="el-icon-caret-right"></span>行业就业排名
    </div>
    <div class="myTable">
      <el-form :inline="true" :model="listQuery" class="demo-form-inline" style="text-align:left;">
        <el-form-item label="调度器名称：">
          <el-input v-model="listQuery.name" class="input-width" placeholder="调度器名称" clearable></el-input>
        </el-form-item>
        <el-form-item>
