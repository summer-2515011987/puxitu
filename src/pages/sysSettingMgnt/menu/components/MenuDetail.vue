    ...
    <el-form
      ...
      <el-form-item label="上级菜单：">
        <el-select v-model="menu.parentId"
                   placeholder="请选择菜单" style="display: block" :loading="parentIdDataLoading">
          <el-option
      ...
      <el-form-item label="是否显示：">
        <el-radio-group v-model="menu.hidden" style="float: left;line-height: 40px;position: relative;font-size: 14px;">
