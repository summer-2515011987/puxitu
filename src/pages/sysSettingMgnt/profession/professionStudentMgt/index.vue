...
<div class="main_contain">
    <div class="headerd">
        <span class="el-icon-caret-right"></span>专业学生数据
    </div>
    <div class="myTable">
     ...
     <el-dialog
          ...
          <el-form :model="dataTable"
              ...
              <el-form-item label="学生姓名：">
                  <el-input class="formStyle" v-model="dataTable.studentName" style="width: 200px"></el-input>
              </el-form-item>
              <el-form-item label="性别：">
                  <el-select v-model="dataTable.studentSex" placeholder="请选择" :style="{width: '200px'}">
                      <el-option v-for="item in sexLists" :key="item.value" :label="item.label" :value="item.label">
                      </el-option>
                  </el-select>
              </el-form-item>
              <el-form-item label="民族：">
                  <el-input class="formStyle" v-model="dataTable.nation" ></el-input>
              </el-form-item>
              <el-form-item label="生源地分布：">
                  <el-input class="formStyle" v-model="dataTable.studentArea" ></el-input>
              </el-form-item>
              <el-form-item label="生源类型：">
                  <el-select v-model="dataTable.studentType" placeholder="请选择" :style="{width: '200px'}">
                      <el-option v-for="item in studentTypes" :key="item.value" :label="item.label" :value="item.label">
                      </el-option>
                  </el-select>
              </el-form-item>
              <el-form-item label="年份：">
              ...
              <el-col :span="12">
                  <el-form-item label="其他情况：">
                      <el-input class="formStyle" v-model="dataTable.other"></el-input>
                  </el-form-item>
              </el-col>
          </el-form>
       ...
       handleFileSuccess(res, file){
        ...
        handleDelete(index, row) {
            this.$confirm('是否要删除?', '提示', {
                ...
                student.deleteInfo(row.id).then(response => {
                    this.$message({
                        type: 'success',
                        message: '删除成功!'
                    });
            ...
            this.$confirm('是否要删除?', '提示', {
                ...
                student.batchDelete(ids).then(response => {
                    this.$message({
                        type: 'success',
                        message: '删除成功!'
                    });
        ...
        handleDialogConfirm() {
            if (this.isEdit) {
                student.updateData(this.dataTable.id, this.dataTable).then(response => {
                    this.$message({
                        message: '修改成功！',
                        type: 'success'
                    });
                ...
                student.createData(this.dataTable).then(response => {
                    this.$message({
                        message: '添加成功！',
                        type: 'success'
                    });
