...
<div class="main_contain">
    <div class="headerd">
        <span class="el-icon-caret-right"></span>专业就业数据
    </div>
    <div class="myTable">
        ...
        <el-table ref="roleTable" header-row-class-name="light_grey_table"   :height="tableHeight"
          ...
          <el-table-column label="年份" width="100" align="center">
            ...
            <el-table-column label="毕业人数" align="center">
                <template slot-scope="scope">{{ scope.row.jiuyenum }}</template>
            </el-table-column>
          ...
          <el-form :model="dataTable"
              ...
              <el-form-item label="省份：">
                  <el-select v-model="dataTable.province" placeholder="请选择" clearable :style="{width: '200px'}" @change="proviceChange">
                      <el-option v-for="(item, index) in proviceLists" :key="index" :label="item.label" :value="item.label"></el-option>
                  </el-select>
              </el-form-item>
              <el-form-item label="院校名称：">
              ...
              <el-form-item label="毕业去向：">
                  <el-select v-model="dataTable.biyequxiang" placeholder="请选择" :style="{width: '200px'}">
                      <el-option v-for="item in biyequxiangs" :key="item.value" :label="item.label" :value="item.label">
                      </el-option>
                  </el-select>
              </el-form-item>
              <el-form-item label="就业地区：">
                  <el-input class="formStyle" v-model="dataTable.jiuyediqu" ></el-input>
              </el-form-item>
              <el-form-item label="平均月薪：">
                  <el-input class="formStyle" v-model="dataTable.xinzi" ></el-input>
              </el-form-item>
              <el-form-item label="对口率：">
                  <el-input class="formStyle" v-model="dataTable.duikouzhuanye" ></el-input>
              </el-form-item>
              <el-form-item label="就业单位：">
                  <el-input class="formStyle" v-model="dataTable.jiuyeqiye" ></el-input>
              </el-form-item>
              <el-form-item label="就业行业：">
                  <el-input class="formStyle" v-model="dataTable.jiuyehangye" ></el-input>
              </el-form-item>
              <el-form-item label="就业职业：">
                      <el-input class="formStyle" v-model="dataTable.jiuyezhiye" ></el-input>
              </el-form-item>
              <el-col :span="12">
                  <el-form-item label="就业人数：">
                      <el-input class="formStyle" v-model="dataTable.jiuyenum" ></el-input>
                  </el-form-item>
              </el-col>
          </el-form>
...
export default {
    ...
    data() {
        return {
            ...
            schoolLists:[],
            dictName:null,
            biyequxiangs:[{value: '0', label: '录用就业'}, {value: '1', label: '学历提升'}, {value: '2', label: '自主创业'}, {value: '3', label: '其他'}]
        }
    },
    created() {
        this.getList();
    ...
    methods: {
       ...
       handleFileSuccess(res, file){
        ...
        handleDialogConfirm() {
            if (this.isEdit) {
                jiuye.updateData(this.dataTable.id, this.dataTable).then(response => {
                    this.$message({
                        message: '修改成功！',
                        type: 'success'
                    });
                ...
                jiuye.createData(this.dataTable).then(response => {
                    this.$message({
                        message: '添加成功！',
                        type: 'success'
                    });
        ...
        getList() {
            ...
            jiuye.fetchList(this.listQuery).then(response => {
