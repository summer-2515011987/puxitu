	...
	export default {
		...
		methods:{
            ...
            showTaskDetail(data){
                ...
                sessionStorage.setItem("smallClassName", data.afterJobclassId);
                sessionStorage.setItem("taskClassName", data.afterClassName);
                this.$router.push({
            ...
            getTaskList(){
                ...
                service.getTempTaskList(params).then(response => {
