<template>
  <div class="main_contain">
    <div class="headerd">
      <span class="el-icon-caret-right"></span>专业岗位数据管理
    </div>
    <div class="myTable">
      ...
      <el-table ref="roleTable" header-row-class-name="light_grey_table"   :height="tableHeight"
        ...
        <el-table-column label="专业名称">
          <template slot-scope="scope">{{ scope.row.small_class }}</template>
        </el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        ...
        professionClearData.fetchProfessionPositionList(this.listQuery).then(response => {
