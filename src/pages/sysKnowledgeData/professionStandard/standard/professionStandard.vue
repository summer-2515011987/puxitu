...
<div class="main_contain" style="height: 700px">
    <div class="headerd">
        <span class="el-icon-caret-right"></span>专业教学标准管理
    </div>
    <div class="myTable">
      <el-form :inline="true" :model="listQuery" label-width="140px" style="text-align:left;">
        ...
        <el-button  type="primary" @click="exportProfessionStandard()"  class="searchBtn" style="float:right;margin-right:20px">导出专业教学标准</el-button>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    exportProfessionStandard() {
      window.open(process.env.BASE_API+"/asdc-datamanage/profession/exportProfessionStandard")
    },
    remove(node, data) {
